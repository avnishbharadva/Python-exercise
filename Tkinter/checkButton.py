...
def chk_click():
    ...
    if checkvar1.get()==0 and checkvar2.get()==0 and checkvar3.get()==0:
        m = "Everyone Is Selfish"
    msg = messagebox.showinfo("hehe",m)

cb1 = Checkbutton(root, text="Html", variable=checkvar1,onvalue=1,offvalue=0)
cb1.pack()
cb2 = Checkbutton(root, text="Css", variable=checkvar2,onvalue=1,offvalue=0)
cb2.pack()
cb3 = Checkbutton(root, text="Javascript", variable=checkvar3,onvalue=1,offvalue=0)
cb3.pack()
b = Button(root, text="Check Status", command=chk_click)
b.pack()
root.mainloop()
